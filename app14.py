...
def accueil(exemple=None):
    ...
    return render_template("accueil4.html", bananes=images)
"""
...
def upload_form():
    return render_template("charger14.html")
...
def upload_image():
    ...
    if file and allowed_file(file.filename):
        ...
        return render_template('charger14.html', filename=filename)
    else:
...
def enregistrer_image():
    ...
    db.session.commit()
    return render_template('charger14.html', filename=filename_data)
