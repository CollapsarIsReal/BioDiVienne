...
def upload_form():
    return render_template("charger18.html")
...
def upload_image():
    ...
    if file and allowed_file(file.filename):
        ...
        return render_template('charger18.html', filename=filename)
    else:
...
def enregistrer_image():
    ...
    db.session.commit()
    return render_template('charger18.html', filename=filename_data)
